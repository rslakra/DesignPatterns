 ...
 *****************************************************************************/
package com.devamatre.patterns.core.behavioral.mediator.ch2;

/**
 * Prrpose : Meditar Design Pattern
 * 	1. Createa an "Intermediatory" that decouples "Producers" and "Consumers"
 * 	2. Produers are coupled only to the Mediator.
 * 	3. Consumers are coupled only to the Mediator.
 * 	4. The Mediator arbitrates storing and reteriving of message.
 * 
 * Mediator centeralizes arbitrary communication between colleges objects.
 * 
 * Intent:-
 * Define an object that encapsulates how a set of obejcts interact. Mediator promotes 
