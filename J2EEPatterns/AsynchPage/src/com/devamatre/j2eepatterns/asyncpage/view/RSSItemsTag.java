package com.devamatre.j2eepatterns.asyncpage.view;
...
import com.devamatre.j2eepatterns.asyncpage.model.RSSInfo;
...
public class RSSItemsTag extends BodyTagSupport implements IterationTag {
	...
	public int doStartTag() throws JspException {
		// Pooled tag instances must reset state each invocation (counter was 4 after last request).
		counter = 0;
