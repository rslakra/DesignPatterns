...
<jsp:useBean id="userbean" scope="session"
	class="com.devamatre.j2eepatterns.decorator.model.UserBeanImpl" />
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	<p>Password must be at least 3 characters for this demo login.</p>
	<form action="<%= request.getContextPath() %>/pages/XMLView.xml" method="post">
