package com.rslakra.j2eepatterns.decorator.controller;
...
import com.rslakra.j2eepatterns.decorator.model.UserBean;
import com.rslakra.j2eepatterns.decorator.model.UserBeanFactory;

/**
 * A simple implementation of a front controller servlet. This servlet
 * intercepts all requests to urls starting with "/pages." After processing it
 * strips "/pages" off the given URL and forwards to that.
 */
public class FrontController extends HttpServlet {
	...
	/**
	 * The common processor method. Check if this user is logged in or not. If
	 * they are not, forward to the login page, otherwise forward to the
	 * requested URL.
	 */
