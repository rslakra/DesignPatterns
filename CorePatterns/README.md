...
[Singleton Example](src/main/java/com/rslakra/designpatterns/creational/singleton)
...
[Factory Method Example](src/main/java/com/rslakra/designpatterns/creational/factory)    
...
[Builder Example](src/main/java/com/rslakra/designpatterns/creational/builder)    
...
[Abstract Factory Example](src/main/java/com/rslakra/designpatterns/creational/abstractfactory)    
...
[Prototype Example](src/main/java/com/rslakra/designpatterns/creational/prototype)    
...
[Adapter Example](src/main/java/com/rslakra/designpatterns/structural/adapter)
...
[Bridge Example](src/main/java/com/rslakra/designpatterns/structural/bridge)
...
[Composite Example](src/main/java/com/rslakra/designpatterns/structural/composite)
...
[Decorator Example](src/main/java/com/rslakra/designpatterns/structural/decorator)
...
[Façade Example](src/main/java/com/rslakra/designpatterns/structural/facade)
...
[Flyweight Example](src/main/java/com/rslakra/designpatterns/structural/flyweight)
...
[Proxy Example](src/main/java/com/rslakra/designpatterns/structural/proxy)
...
[Mediator Example](src/main/java/com/rslakra/designpatterns/behavioral/mediator)

#### 3.2. Memento Pattern

    Capture and restore an object's internal state with out violating encapsulation.
    
[Memento Example](src/main/java/com/rslakra/designpatterns/behavioral/memento)

#### 3.3. Interpreter Pattern

    A way to include language elements in a program.
    
[Interpreter Example](src/main/java/com/rslakra/designpatterns/behavioral/interpreter)

#### 3.4. Iterator Pattern

    Sequentially access the elements of a collection.

[Iterator Example](src/main/java/com/rslakra/designpatterns/behavioral/iterator)
...
[Chain of Responsibility Example](src/main/java/com/rslakra/designpatterns/behavioral/chainofresponsibility)

#### 3.6. Command Pattern

    Encapsulate a command request as an object.
    
[Command Example](src/main/java/com/rslakra/designpatterns/behavioral/command)

#### 3.7. State Pattern

    It allows an object to change its behavior when it's state changes.

[State Example](src/main/java/com/rslakra/designpatterns/behavioral/state)
...
[Strategy Example](src/main/java/com/rslakra/designpatterns/behavioral/strategy)
...
[Observer Example](src/main/java/com/rslakra/designpatterns/behavioral/observer)
...
[Template Example](src/main/java/com/rslakra/designpatterns/behavioral/template)
...
[Visitor Example](src/main/java/com/rslakra/designpatterns/behavioral/visitor)
